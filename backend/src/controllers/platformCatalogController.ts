...
import {
  ...
  deletePlatformBlog as removePlatformBlog,

  deletePlatformEvent as removePlatformEvent,

  deletePlatformService as removePlatformService,
...
export const getPlatformServices = async (req: any, res: Response) => {
  ...
  try {
    ...
    const services = listPlatformServices().sort(
...
export const deletePlatformService = async (req: any, res: Response) => {
  ...
  try {
    ...
    if (!removePlatformService(id)) {

      return res.status(404).json({ message: 'Platform service not found' });
...
export const getPlatformEvents = async (req: any, res: Response) => {
  ...
  try {
    ...
    const events = listPlatformEvents().sort(
...
export const deletePlatformEvent = async (req: any, res: Response) => {
  ...
  try {
    ...
    if (!removePlatformEvent(id)) {

      return res.status(404).json({ message: 'Platform event not found' });
...
export const getPlatformBlogs = async (req: any, res: Response) => {
  ...
  try {
    ...
    const blogs = await attachBlogAuthors(listPlatformBlogs());
...
export const deletePlatformBlog = async (req: any, res: Response) => {
  ...
  try {
    ...
    if (!removePlatformBlog(id)) {

      return res.status(404).json({ message: 'Platform blog not found' });
